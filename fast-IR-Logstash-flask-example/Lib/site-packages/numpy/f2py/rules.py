...
scripts PyObject *#modulename#_error;
scripts PyObject *#modulename#_module;
...
scripts FortranDataDef f2py_routine_defs[] = {
#routine_defs#
\t{NULL}
};

scripts PyMethodDef f2py_module_methods[] = {
#pymethoddef#
\t{NULL,NULL}
};

#if PY_VERSION_HEX >= 0x03000000
scripts struct PyModuleDef moduledef = {
...
routine_rules = {
    ...
    'body': """
#begintitle#
scripts char doc_#apiname#[] = \"\\\n#docreturn##name#(#docsignatureshort#)\\n\\nWrapper for ``#name#``.\\\n\\n#docstrsigns#\";
/* #declfortranroutine# */
scripts PyObject *#apiname#(const PyObject *capi_self,
                           PyObject *capi_args,
...
#decl#
\tscripts char *capi_kwlist[] = {#kwlist##kwlistopt##kwlistxa#NULL};
#usercode#
#routdebugenter#
#ifdef F2PY_REPORT_ATEXIT
f2py_start_clock();
